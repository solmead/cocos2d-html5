import { Size } from "../cocos2d/core/cocoa/index";
...
class System {
    ...
    private getOs() {
        ...
        if (nav.appVersion.indexOf("Win") !== -1) osName = OSS.WINDOWS;
        else if (this.iOS) osName = OSS.IOS;
        else if (nav.appVersion.indexOf("Mac") !== -1) osName = OSS.OSX;
        else if (nav.appVersion.indexOf("X11") !== -1 && nav.appVersion.indexOf("Linux") === -1) osName = OSS.LINUX;
        else if (this.isAndroid) osName = OSS.ANDROID;
        else if (nav.appVersion.indexOf("Linux") !== -1) osName = OSS.LINUX;
    ...
    private detectCapabilities() {
         ...
         * @type {Object}
         */
        var capabilities: iCapabilities = this.capabilities = <iCapabilities>{
    ...
    constructor() {
        ...
        currLanguage = currLanguage ? currLanguage : (<any>nav).browserLanguage;
     ...
     * @type {Number}
     */
    platform: OsType = this.isMobile ? OsType.MOBILE_BROWSER : OsType.DESKTOP_BROWSER;
     ...
     * @type {String}
     */
    browserType:string = BROWSER_TYPES.UNKNOWN;
    ...
    _supportCanvasNewBlendModes:boolean = (function () {
