...
import { Texture2D, getNewTexture2D } from "./CCTexture2D";
...
class TextureCache {
    constructor() {
        ...
        this._textureColorsCache = new Dictionary();
        this._textureKeySeq = (0 | Math.random() * 1000);
        this._loadedTexturesBefore = new Dictionary();
        this.handleLoadedTexture = (url, img) => {
         ...
         */
        this.addImageAsync = async (url, target) => {
    ...
    getTextureColors(texture) {
        ...
        if (!this._textureColorsCache.get(key))
            this._textureColorsCache.set(key, texture._generateTextureCacheForColor());
...
//# sourceMappingURL=CCTextureCache.js.map